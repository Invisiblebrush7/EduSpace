...
const deleteSubject = async (subjectID, teacherID) => {
	await fetch(`/materias/delete/${subjectID}/${teacherID}`, {
		method: 'DELETE',
		headers: {
...
function subjectToHTML(subject) {
	...
	<div class="container-card">
		<div class="product-details">
			...
			<a href="/ver" class="openSubjectModal" data-teacherID="${subject.teacherID}" data-name="${subject.name}" data-description="${subject.description}">
				<i class="fa-solid fa-eye"></i>
			</a>
			<button  onClick="deleteSubject('${subject._id}','${subject.teacherID}')">
